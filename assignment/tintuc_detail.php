                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <ul class="breadcrumb justify-content-center">
                            ...
                            <li class="current"><a href="blog-details-image.html">Tin Tức Details</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <article class="post post-details mb--30">
                                    ...
                                    <div class="post-info">
                                        <header class="entry-header">
                                            ...
                                            <h2 class="post-title">Blog Image Post</h2>
                                        </header>
                                        <div class="post-content">
                                            <p>Donec vitae hendrerit arcu, sit amet faucibus nisl. Cras pretium arcu ex.
                                                Aenean posuere libero eu augue condimentum rhoncus. Praesent ornare
                                                tortor ac ante egestas hendrerit. Aliquam et metus pharetra, bibendum
                                                massa nec, fermentum odio. Nunc id leo ultrices, mollis ligula in,
                                                finibus tortor. Mauris eu dui ut lectus fermentum eleifend. Pellentesque
                                                faucibus sem ante, non malesuada odio varius nec. Suspendisse potenti.
                                            </p>

                                            <blockquote>Quisque semper nunc vitae erat pellentesque, ac placerat arcu
                                                ...
                                                finibus tortor eu scelerisque scelerisque.</blockquote>

                                            <p>Aenean et tempor eros, vitae sollicitudin velit. Etiam varius enim nec
                                            ...
                                            <p>Suspendisse turpis ipsum, tempus in nulla eu, posuere pharetra nibh. In
                                                ...
                                                orci id nulla maximus maximus. Nunc pulvinar sollicitudin molestie.</p>
                                        </div>
                                        ...
                                        <div class="social__sharing mb--30">
                                            ...
                                            <ul class="social social-round">
                                                ...
                                                <li class="social__item">
                                                    <a href="pinterest.html" class="social__link"><i class="fa fa-pinterest"></i></a>
                                                </li>
                                                <li class="social__item">
                                                    <a href="google.plus.html" class="social__link"><i class="fa fa-google-plus"></i></a>
                                                </li>
                                                <li class="social__item">
                                                    <a href="linkedin.html" class="social__link"><i class="fa fa-linkedin"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="related-posts-wrap">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 mb-md--30">
                                                <div class="related-post">
                                                    <a href="blog-details-image.html" class="related-post__thumb">
                                                        <img src="assets/img/blog/blog1.jpg" alt="portfolio">
                                                    </a>
                                            ...
                                            <div class="col-lg-4 mb-md--30">
                                                <div class="related-post">
                                                    <a href="single-portfolio.html" class="related-post__thumb">
                                                        <img src="assets/img/blog/blog2-1024x613.jpg" alt="portfolio">
                                                    </a>
                                                    <h4><a href="blog-details-image.html">TAKE A RIDE IN A LUXURY
                                                            CAR</a></h4>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="related-post">
                                                    <a href="blog-details-image.html" class="related-post__thumb">
                                                        <img src="assets/img/blog/blog3.jpg" alt="portfolio">
                                                    </a>
                                    ...
                                    <div class="comment-respond">
                                        ...
                                        <form class="form comment-form">
                                            <p class="comment-notes"><span id="email-notes">Your email address will not
                                                    be published.</span> Required fields are marked <span class="required">*</span></p>
