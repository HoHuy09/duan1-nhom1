            ...
            <div class="wrapper__content">
                ...
                <div class="content__box">
                    ...
                    <form action="" class="content__box-product-add" method="POST" enctype="multipart/form-data">
                        <h3 class="content__box-product-add-name">Thêm danh mục</h3>
                        <?php
                            if(!empty($msg)){
                                ?>
                                <p class="msg-err">
                        ...
                        <div class="content__box-product-add-field">
                            ...
                            <input type="text" name="name" placeholder="tên danh mục" class="input-txt">
                        </div>
                        <div class="content__box-product-add-btn" style="width: 552px">
                            <button class="content__box-product-btn" name="btnAdd">Thêm danh mục</button>
                        </div>
                    </form>
                </div>
